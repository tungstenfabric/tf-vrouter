...
main(int argc, char *argv[])
{
    ...
    while ((opt = getopt_long(argc, argv, "TcdbmPM:p:l:n:v:t:s:e:f:u:r:Fx:",
    ...
    if (monitor) {
        /*
         * Sandesh Request is sent to get the actual genetlink_group_id and
         * will be received through rt_monitor_group_process() callback function.
         * This new group_id will be used in vr_get_nl_client() to avoid group_id
         * mismatch.
         */
