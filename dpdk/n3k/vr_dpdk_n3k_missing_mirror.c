...
int
vr_dpdk_n3k_offload_missing_mirrors_add(uint32_t id, uint32_t flow_id) {
    return vr_dpdk_n3k_missing_mirror_map_add(missing_mirrors, id, flow_id);
}

int
vr_dpdk_n3k_offload_missing_mirror_vifs_add(uint32_t id, uint32_t flow_id) {
    return vr_dpdk_n3k_missing_mirror_map_add(missing_mirror_vifs, id, flow_id);
}

int
vr_dpdk_n3k_offload_missing_mirror_nexthops_add(uint32_t id, uint32_t flow_id) {
...
vr_dpdk_n3k_missing_mirror_flow_offload(uint32_t flow_id) {
    ...
    return vr_dpdk_n3k_offload_flow_update(flow);
}
...
void
vr_dpdk_n3k_offload_missing_mirror_flows(uint32_t id) {
    vr_dpdk_n3k_missing_mirror_offload_postponed_flows(missing_mirrors, id);
}

void
vr_dpdk_n3k_offload_missing_vif_flows(uint32_t id) {
    vr_dpdk_n3k_missing_mirror_offload_postponed_flows(missing_mirror_vifs, id);
}

void
vr_dpdk_n3k_offload_missing_nexthop_flows(uint32_t id) {
