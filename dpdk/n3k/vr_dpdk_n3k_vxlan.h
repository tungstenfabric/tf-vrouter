...
/* vxlan mappings use atomics under the hood, so this getter (and other
 * functions) are threadsafe */
int vr_dpdk_n3k_offload_vxlan_get_by_vni(uint32_t vnid, struct vr_n3k_offload_vxlan *out);

int vr_dpdk_n3k_offload_vxlan_insert_copy_for_test(struct vr_n3k_offload_vxlan vxlan);
