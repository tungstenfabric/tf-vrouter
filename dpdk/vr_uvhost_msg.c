 ...
 */
static int
uvhm_check_vring_ready(vr_uvh_client_t *vru_cl, unsigned int vring_idx, int enable)
{
...
{
    vr_uvh_client_t *vru_cl;
    uint64_t support_flags, features;
    uint8_t is_gso_vm = 1;
     ...
     */
    rte_vhost_driver_get_features(vru_cl->vruc_path, &features);
