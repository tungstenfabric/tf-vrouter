...
#define PKT_RX_VLAN PKT_RX_VLAN_PKT
     ...
     #error "vRouter needs atleast DPDK version 19.11 to start"
#endif
...
/* check availability of enough lcores */
#if (RTE_MAX_LCORE < 256)
#error "vrouter needs to have support 256 lcores for AMD processors"
#endif
...
#define VR_DPDK_DDP_NOT_SUPPORTED -1000
#define VR_DPDK_DDP_FAILED        -1001
...
struct rte_mbuf* dpdk_create_mss_chained_mbuf(struct rte_mbuf** m, struct vr_packet* pkt);
