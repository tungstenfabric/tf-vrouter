...
extern int vr_send_nexthop_encap_tunnel_add(struct nl_client *, unsigned int,
        unsigned int, int, unsigned int, int, int *, int8_t [][6], int8_t [][6],
        struct in_addr, struct in_addr, int, int, int8_t *, int, int);
...
extern int vr_send_ddp_req(struct nl_client *, vr_info_msg_en, uint8_t * );
