...
static void
test_same_cn_2_net_snat(void **state)
{
    /* GIVEN vr_n3k_offload_entry definition */
    const uint16_t src_port_id = 5;
    const uint16_t dst_port_id = 6;
    ...
    struct vr_eth dst_nh_data = {
        .eth_smac = { 0x00, 0x11, 0x22, 0x33, 0x44, 0x55 },
        .eth_dmac = { 0x00, 0x55, 0x44, 0x33, 0x22, 0x11 },
    };
    ...
    assert_memory_equal(
        vf_action_set_dmac->mac_addr, dst_nh_data.eth_dmac, VR_ETHER_ALEN);
...
static void
test_same_cn_2_net_dnat(void **state)
{
    /* GIVEN vr_n3k_offload_entry definition */
    const uint16_t src_port_id = 5;
    const uint16_t dst_port_id = 6;
...
static void
test_2_cn_same_net_snat_vxlan(void **state)
{
    /* GIVEN vr_n3k_offload_entry definition */
...
static void
test_2_cn_same_net_dnat_vxlan(void **state)
{
    /* GIVEN vr_n3k_offload_entry definition */
...
static void
test_2_cn_same_net_snat_mpls(void **state)
{
    const uint16_t src_port_id = 5;
    ...
    assert_int_equal(
        encap_action_conf->size,
        sizeof(struct rte_ether_hdr) + ip_hdr_size +
            sizeof(struct rte_udp_hdr) + sizeof(struct rte_mpls_hdr));
...
static void
test_2_cn_same_net_dnat_mpls(void **state)
{
    /* GIVEN vr_n3k_offload_entry definition */
...
static void
test_2_cn_2_net_snat_mpls(void **state)
{
    /**** GIVEN ****/
...
static void
test_2_cn_2_net_dnat_mpls(void **state)
{
    /* GIVEN vr_n3k_offload_entry definition */
    const uint16_t src_port_phy = 3;
    const uint32_t dst_port_id = 5;
...
main(void)
{
    const struct CMUnitTest tests[] = {
        ...
        cmocka_unit_test(test_same_cn_2_net_snat),
        cmocka_unit_test(test_same_cn_2_net_dnat),
        cmocka_unit_test(test_2_cn_same_net_snat_vxlan),
        cmocka_unit_test(test_2_cn_same_net_dnat_vxlan),
        cmocka_unit_test(test_2_cn_same_net_snat_mpls),
        cmocka_unit_test(test_2_cn_same_net_dnat_mpls),
        cmocka_unit_test(test_2_cn_2_net_snat_mpls),
        cmocka_unit_test(test_2_cn_2_net_dnat_mpls),
    };
