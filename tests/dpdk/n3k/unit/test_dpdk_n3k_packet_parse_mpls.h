...
struct packet_mpls_udp_eth_ipv6_udp {
    struct rte_ether_hdr eth_hdr;
    struct rte_ipv4_hdr ipv4_hdr;
    struct rte_udp_hdr udp_hdr;
    struct rte_mpls_hdr mpls_hdr;
...
struct packet_mpls_udp_ipv6_udp {
    struct rte_ether_hdr eth_hdr;
    struct rte_ipv4_hdr ipv4_hdr;
    struct rte_udp_hdr udp_hdr;
    struct rte_mpls_hdr mpls_hdr;
...
struct packet_mpls_udp_eth_ipv6_tcp {
    struct rte_ether_hdr eth_hdr;
    struct rte_ipv4_hdr ipv4_hdr;
    struct rte_udp_hdr udp_hdr;
    struct rte_mpls_hdr mpls_hdr;
...
struct packet_mpls_udp_ipv6_tcp {
    struct rte_ether_hdr eth_hdr;
    struct rte_ipv4_hdr ipv4_hdr;
    struct rte_udp_hdr udp_hdr;
    struct rte_mpls_hdr mpls_hdr;
...
struct packet_mpls_udp_eth_ipv6_only {
    struct rte_ether_hdr eth_hdr;
    struct rte_ipv4_hdr ipv4_hdr;
    struct rte_udp_hdr udp_hdr;
    struct rte_mpls_hdr mpls_hdr;
...
static struct packet_mpls_udp_eth_ipv6_udp data_mpls_udp_packet_ipv6 = {
    .eth_hdr = {
        .s_addr = { .addr_bytes = { 0x00, 0xaa, 0xaa, 0x00, 0x00, 0x02 } },
        .d_addr = { .addr_bytes = { 0x00, 0xaa, 0xaa, 0x00, 0x00, 0x01 } },
        .ether_type = RTE_BE16(ETHERTYPE_IP),
...
static struct packet_mpls_udp_ipv6_udp data_mpls_udp_l3_packet_ipv6 = {
    .eth_hdr = {
        .s_addr = { .addr_bytes = { 0x00, 0xaa, 0xaa, 0x00, 0x00, 0x02 } },
        .d_addr = { .addr_bytes = { 0x00, 0xaa, 0xaa, 0x00, 0x00, 0x01 } },
        .ether_type = RTE_BE16(ETHERTYPE_IP),
...
static struct packet_mpls_udp_eth_ipv6_tcp data_mpls_tcp_packet_ipv6 = {
    .eth_hdr = {
        .s_addr = { .addr_bytes = { 0x00, 0xaa, 0xaa, 0x00, 0x00, 0x02 } },
        .d_addr = { .addr_bytes = { 0x00, 0xaa, 0xaa, 0x00, 0x00, 0x01 } },
        .ether_type = RTE_BE16(ETHERTYPE_IP),
...
static struct packet_mpls_udp_ipv6_tcp data_mpls_tcp_l3_packet_ipv6 = {
    .eth_hdr = {
        .s_addr = { .addr_bytes = { 0x00, 0xaa, 0xaa, 0x00, 0x00, 0x02 } },
        .d_addr = { .addr_bytes = { 0x00, 0xaa, 0xaa, 0x00, 0x00, 0x01 } },
        .ether_type = RTE_BE16(ETHERTYPE_IP),
...
static struct packet_mpls_udp_eth_ipv6_only data_mpls_ipv6_icmp_packet = {
    .eth_hdr = {
        .s_addr = { .addr_bytes = { 0x00, 0xaa, 0xaa, 0x00, 0x00, 0x02 } },
        .d_addr = { .addr_bytes = { 0x00, 0xaa, 0xaa, 0x00, 0x00, 0x01 } },
        .ether_type = RTE_BE16(ETHERTYPE_IP),
...
static struct packet_mpls_udp_ipv6_only data_mpls_ipv6_icmp_l3_packet = {
    .eth_hdr = {
        .s_addr = { .addr_bytes = { 0x00, 0xaa, 0xaa, 0x00, 0x00, 0x02 } },
        .d_addr = { .addr_bytes = { 0x00, 0xaa, 0xaa, 0x00, 0x00, 0x01 } },
        .ether_type = RTE_BE16(ETHERTYPE_IP),
