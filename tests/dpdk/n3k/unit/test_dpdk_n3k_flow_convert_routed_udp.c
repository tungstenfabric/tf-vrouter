...
static void
test_same_cn_2_net_ipv6_forward(void **state)
{
    /* GIVEN vr_n3k_offload_entry definition */
    const uint16_t src_port_id = 5;
    const uint16_t dst_port_id = 6;
...
static void
test_same_cn_2_net_ipv6_drop(void **state)
{
    /* GIVEN vr_n3k_offload_entry definition */
    const uint16_t src_port_id = 1;
    const uint16_t dst_port_id = 2;
...
main(void)
{
    const struct CMUnitTest tests[] = {
        ...
        cmocka_unit_test(test_same_cn_2_net_ipv6_forward),
        cmocka_unit_test(test_same_cn_2_net_ipv6_drop),
    };

    return cmocka_run_group_tests_name(
        "vr_dpdk_n3k_flow_convert_routed_udp", tests, NULL, NULL);
}
