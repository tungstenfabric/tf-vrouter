...
vr_dpdk_n3k_offload_mpls_get_by_label(uint32_t label, struct vr_n3k_offload_mpls *out)
{
    ...
    struct vr_n3k_offload_mpls *ret = mock_ptr_type(struct vr_n3k_offload_mpls*);
    if (!ret)
        return -ENOENT;
...
test_parse_packet_key_from_mpls_l2_udp_on_fabric_ingress(void **state)
{
    ...
    expect_value(vr_dpdk_n3k_get_key_nh_from_l2_nh_ipv4, l2_nh_id, MPLS_OFF_L2.nexthop_id);
    expect_value(vr_dpdk_n3k_get_key_nh_from_l2_nh_ipv4, ip_addr,
        data_mpls_udp_packet.inner_ipv4_hdr.dst_addr);
    will_return(vr_dpdk_n3k_get_key_nh_from_l2_nh_ipv4, VIRTUAL_1_VIF.vif_nh_id);
    will_return(vr_dpdk_n3k_get_key_nh_from_l2_nh_ipv4, 0);
    ...
    assert_int_equal(key.ip.src.ipv4, data_mpls_udp_packet.inner_ipv4_hdr.src_addr);
    assert_int_equal(key.ip.dst.ipv4, data_mpls_udp_packet.inner_ipv4_hdr.dst_addr);
...
test_parse_packet_key_from_mpls_l3_udp_on_fabric_ingress(void **state)
{
    ...
    assert_int_equal(key.nh_id, VIRTUAL_1_VIF.vif_nh_id);
    assert_int_equal(key.ip.type, VR_N3K_IP_TYPE_IPV4);
    assert_int_equal(key.ip.src.ipv4, data_mpls_udp_l3_packet.inner_ipv4_hdr.src_addr);
    assert_int_equal(key.ip.dst.ipv4, data_mpls_udp_l3_packet.inner_ipv4_hdr.dst_addr);
    assert_int_equal(key.proto, IPPROTO_UDP);
...
test_parse_packet_key_from_mpls_l2_tcp_on_fabric_ingress(void **state)
{
    ...
    assert_int_equal(key.nh_id, VIRTUAL_1_VIF.vif_nh_id);
    assert_int_equal(key.ip.type, VR_N3K_IP_TYPE_IPV4);
    assert_int_equal(key.ip.src.ipv4, data_mpls_tcp_packet.inner_ipv4_hdr.src_addr);
    assert_int_equal(key.ip.dst.ipv4, data_mpls_tcp_packet.inner_ipv4_hdr.dst_addr);
...
test_parse_packet_key_from_mpls_l3_tcp_on_fabric_ingress(void **state)
{
    ...
    assert_int_equal(key.nh_id, VIRTUAL_1_VIF.vif_nh_id);
    assert_int_equal(key.ip.type, VR_N3K_IP_TYPE_IPV4);
    assert_int_equal(key.ip.src.ipv4, data_mpls_tcp_l3_packet.inner_ipv4_hdr.src_addr);
    assert_int_equal(key.ip.dst.ipv4, data_mpls_tcp_l3_packet.inner_ipv4_hdr.dst_addr);
    assert_int_equal(key.proto, IPPROTO_TCP);
...
static void
test_parse_packet_ipv6_key_from_mpls_l2_udp_on_fabric_ingress(void **state)
{
    struct vr_packet pkt = {
        .vp_if = &PHYSICAL_VIF,
        .vp_nh = &test_nexthops[PHYSICAL_VIF.vif_nh_id],
        .vp_head = (uint8_t *)&data_mpls_udp_packet_ipv6,
        .vp_data = 0,
    };
    ...
    expect_value(vr_dpdk_n3k_get_key_nh_from_l2_nh_ipv6, l2_nh_id, MPLS_OFF_L2.nexthop_id);
    expect_memory(
        vr_dpdk_n3k_get_key_nh_from_l2_nh_ipv6,
        ip_addr,
        data_mpls_udp_packet_ipv6.inner_ipv6_hdr.dst_addr,
        VR_IP6_ADDRESS_LEN);
    will_return(vr_dpdk_n3k_get_key_nh_from_l2_nh_ipv6, VIRTUAL_1_VIF.vif_nh_id);
    will_return(vr_dpdk_n3k_get_key_nh_from_l2_nh_ipv6, 0);
    ...
    assert_memory_equal(key.ip.src.ipv6,
                        data_mpls_udp_packet_ipv6.inner_ipv6_hdr.src_addr,
                        VR_IP6_ADDRESS_LEN);
    assert_memory_equal(key.ip.dst.ipv6,
                        data_mpls_udp_packet_ipv6.inner_ipv6_hdr.dst_addr,
                        VR_IP6_ADDRESS_LEN);
    assert_int_equal(key.proto, IPPROTO_UDP);
    assert_int_equal(key.src_port, data_mpls_udp_packet_ipv6.inner_udp_hdr.src_port);
    assert_int_equal(key.dst_port, data_mpls_udp_packet_ipv6.inner_udp_hdr.dst_port);
}

static void
test_parse_packet_ipv6_key_from_mpls_l3_udp_on_fabric_ingress(void **state)
{
    struct vr_packet pkt = {
        .vp_if = &PHYSICAL_VIF,
        .vp_nh = &test_nexthops[PHYSICAL_VIF.vif_nh_id],
        .vp_head = (uint8_t *)&data_mpls_udp_l3_packet_ipv6,
        .vp_data = 0,
    };
    ...
    assert_int_equal(key.ip.type, VR_N3K_IP_TYPE_IPV6);
    assert_memory_equal(key.ip.src.ipv6,
                        data_mpls_udp_l3_packet_ipv6.inner_ipv6_hdr.src_addr,
                        VR_IP6_ADDRESS_LEN);
    assert_memory_equal(key.ip.dst.ipv6,
                        data_mpls_udp_l3_packet_ipv6.inner_ipv6_hdr.dst_addr,
                        VR_IP6_ADDRESS_LEN);
    assert_int_equal(key.proto, IPPROTO_UDP);
    assert_int_equal(key.src_port, data_mpls_udp_l3_packet_ipv6.inner_udp_hdr.src_port);
    assert_int_equal(key.dst_port, data_mpls_udp_l3_packet_ipv6.inner_udp_hdr.dst_port);
}

static void
test_parse_packet_ipv6_key_from_mpls_l2_tcp_on_fabric_ingress(void **state)
{
    struct vr_packet pkt = {
        .vp_if = &PHYSICAL_VIF,
        .vp_nh = &test_nexthops[PHYSICAL_VIF.vif_nh_id],
        .vp_head = (uint8_t *)&data_mpls_tcp_packet_ipv6,
        .vp_data = 0,
    };
    ...
    expect_memory(
        vr_dpdk_n3k_get_key_nh_from_l2_nh_ipv6,
        ip_addr,
        data_mpls_tcp_packet_ipv6.inner_ipv6_hdr.dst_addr,
        VR_IP6_ADDRESS_LEN);
    will_return(vr_dpdk_n3k_get_key_nh_from_l2_nh_ipv6, VIRTUAL_1_VIF.vif_nh_id);
    will_return(vr_dpdk_n3k_get_key_nh_from_l2_nh_ipv6, 0);
    ...
    assert_int_equal(key.ip.type, VR_N3K_IP_TYPE_IPV6);
    assert_memory_equal(key.ip.src.ipv6,
                        data_mpls_tcp_packet_ipv6.inner_ipv6_hdr.src_addr,
                        VR_IP6_ADDRESS_LEN);
    assert_memory_equal(key.ip.dst.ipv6,
                        data_mpls_tcp_packet_ipv6.inner_ipv6_hdr.dst_addr,
                        VR_IP6_ADDRESS_LEN);
    assert_int_equal(key.proto, IPPROTO_TCP);
    assert_int_equal(key.src_port, data_mpls_tcp_packet_ipv6.inner_tcp_hdr.src_port);
    assert_int_equal(key.dst_port, data_mpls_tcp_packet_ipv6.inner_tcp_hdr.dst_port);
}

static void
test_parse_packet_ipv6_key_from_mpls_l3_tcp_on_fabric_ingress(void **state)
{
    struct vr_packet pkt = {
        .vp_if = &PHYSICAL_VIF,
        .vp_nh = &test_nexthops[PHYSICAL_VIF.vif_nh_id],
        .vp_head = (uint8_t *)&data_mpls_tcp_l3_packet_ipv6,
        .vp_data = 0,
    };
    ...
    assert_int_equal(key.ip.type, VR_N3K_IP_TYPE_IPV6);
    assert_memory_equal(key.ip.src.ipv6,
                        data_mpls_tcp_l3_packet_ipv6.inner_ipv6_hdr.src_addr,
                        VR_IP6_ADDRESS_LEN);
    assert_memory_equal(key.ip.dst.ipv6,
                        data_mpls_tcp_l3_packet_ipv6.inner_ipv6_hdr.dst_addr,
                        VR_IP6_ADDRESS_LEN);
    assert_int_equal(key.proto, IPPROTO_TCP);
    assert_int_equal(key.src_port, data_mpls_tcp_l3_packet_ipv6.inner_tcp_hdr.src_port);
    assert_int_equal(key.dst_port, data_mpls_tcp_l3_packet_ipv6.inner_tcp_hdr.dst_port);
}

static void
test_parse_packet_ipv6_metadata_from_mpls_l2_on_fabric_ingress(void **state)
{
    struct vr_packet pkt = {
        .vp_if = &PHYSICAL_VIF,
        .vp_nh = &test_nexthops[PHYSICAL_VIF.vif_nh_id],
    ...
    expect_value(vr_dpdk_n3k_get_key_nh_from_l2_nh_ipv6, l2_nh_id, MPLS_OFF_L2.nexthop_id);
    expect_value(vr_dpdk_n3k_get_key_nh_from_l2_nh_ipv6, ip_addr,
        data_mpls_udp_packet_ipv6.inner_ipv6_hdr.dst_addr);
    will_return(vr_dpdk_n3k_get_key_nh_from_l2_nh_ipv6, VIRTUAL_1_VIF.vif_nh_id);
    will_return(vr_dpdk_n3k_get_key_nh_from_l2_nh_ipv6, 0);
    ...
    assert_memory_equal(
        &metadata.inner_src_mac[0],
        &data_mpls_udp_packet_ipv6.inner_eth_hdr.s_addr.addr_bytes[0],
        ETHER_ADDR_LEN);
    assert_memory_equal(
        &metadata.inner_dst_mac[0],
        &data_mpls_udp_packet_ipv6.inner_eth_hdr.d_addr.addr_bytes[0],
        ETHER_ADDR_LEN);
}

static void
test_parse_packet_ipv6_metadata_from_mpls_l3_on_fabric_ingress(void **state)
{
    struct vr_packet pkt = {
        .vp_if = &PHYSICAL_VIF,
        .vp_nh = &test_nexthops[PHYSICAL_VIF.vif_nh_id],
...
static void
test_parse_packet_ipv6_returns_notsup_on_l2_encapsulated_icmpv6_on_fabric_rx(void **state)
{
    struct vr_packet pkt = {
        .vp_if = &PHYSICAL_VIF,
        .vp_nh = &test_nexthops[PHYSICAL_VIF.vif_nh_id],
        .vp_head = (uint8_t *)&data_mpls_ipv6_icmp_packet,
        .vp_data = 0,
    };
    ...
    expect_value(vr_dpdk_n3k_get_key_nh_from_l2_nh_ipv6, l2_nh_id, MPLS_OFF_L2.nexthop_id);
    expect_value(vr_dpdk_n3k_get_key_nh_from_l2_nh_ipv6, ip_addr,
        data_mpls_ipv6_icmp_packet.inner_ipv6_hdr.dst_addr);
    will_return(vr_dpdk_n3k_get_key_nh_from_l2_nh_ipv6, VIRTUAL_1_VIF.vif_nh_id);
    will_return(vr_dpdk_n3k_get_key_nh_from_l2_nh_ipv6, 0);
...
static void
test_parse_packet_ipv6_returns_notsup_on_l3_encapsulated_icmpv6_on_fabric_rx(void **state)
{
    struct vr_packet pkt = {
        .vp_if = &PHYSICAL_VIF,
        .vp_nh = &test_nexthops[PHYSICAL_VIF.vif_nh_id],
        .vp_head = (uint8_t *)&data_mpls_ipv6_icmp_l3_packet,
        .vp_data = 0,
    };
...
main(void)
{
    const struct CMUnitTest tests[] = {
        ...
        /* IPv6 */
        cmocka_unit_test(test_parse_packet_ipv6_key_from_mpls_l2_udp_on_fabric_ingress),
        cmocka_unit_test(test_parse_packet_ipv6_key_from_mpls_l3_udp_on_fabric_ingress),
        cmocka_unit_test(test_parse_packet_ipv6_key_from_mpls_l2_tcp_on_fabric_ingress),
        cmocka_unit_test(test_parse_packet_ipv6_key_from_mpls_l3_tcp_on_fabric_ingress),

        cmocka_unit_test(test_parse_packet_ipv6_metadata_from_mpls_l2_on_fabric_ingress),
        cmocka_unit_test(test_parse_packet_ipv6_metadata_from_mpls_l3_on_fabric_ingress),

        cmocka_unit_test(test_parse_packet_ipv6_returns_notsup_on_l2_encapsulated_icmpv6_on_fabric_rx),
        cmocka_unit_test(test_parse_packet_ipv6_returns_notsup_on_l3_encapsulated_icmpv6_on_fabric_rx),
    };
